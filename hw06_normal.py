...
# 5. Получить список всех Учителей, преподающих в указанном классеазанным условиям: ', numb_list2)

import random
NAME = ('А.', 'Б.', 'В.', 'Г.', 'Д.', 'Е.', 'М.', 'Н.', 'П.', 'Р.')
SURNAME = ('Иванов', 'Смирнов', 'Петров', 'Сидоров', 'Сергеев', 'Дмитриев', 'Алексеев', 'Андреев', 'Ильин')
SUBJECT = ('Математика', 'Русский язык', 'Физика', 'Литература', 'Химия', 'Информатика', 'История', 'География', 'ИЗО')
class School():
